...
r=Path('D:/CHICK/SullyOS/output/sailor-girl');bpy.ops.wm.open_mainfile(filepath=str(r/'source-1.blend'));ob=next(o for o in bpy.data.objects if o.type=='MESH');bpy.context.view_layer.objects.active=ob;bpy.ops.object.transform_apply(location=True,rotation=True,scale=True)
