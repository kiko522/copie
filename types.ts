 ...
 * 以 extraItems 注入捏人器，合并进对应类目的 PARTS。
 */
...
export interface BankCardStyle {
    ...
    artwork?: {
        layout?: 'flightline' | 'caleb-reference';
        backgroundImage: string;
...
export type MessageType = 'text' | 'image' | 'emoji' | 'voice' | 'collaboration_file' | 'interaction' | 'transfer' | 'system' | 'social_card' | 'chat_forward' | 'xhs_card' | 'score_card' | 'music_card' | 'mcd_card' | 'luckin_card' | 'html_card' | 'news_card' | 'trpg_card' | 'novel_card' | 'world_card' | 'sim_card' | 'phone_card' | 'webpage_card' | 'theater_card' | 'room_card' | 'life_card' | 'group_topic_card';
