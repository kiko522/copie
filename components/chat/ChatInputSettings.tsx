    ...
    return (
        <div className="space-y-1">
            ...
            {([
                ...
                {
                    key: 'autoReply',
                    label: '发完后自动生成回复（全部聊天）',
                    help: '这是当前设备全部聊天共用的旧开关：发过文字、图片或表情后，等输入框没有草稿和光标、加号等底部面板全部收起，再等 2 秒让对方回复。若只想给当前角色开启，请使用下方“收起键盘后自动回复”。' + (scope === 'group' ? '群聊沿用本群的导演或轮询模式；退出群聊会取消等待。' : ''),
                },
                {
